...
module.exports = {
  ...
  plugins: [
    ...
    ["@semantic-release/exec", {
      prepareCmd: 'VERSION=${nextRelease.version} npm run bump-version:' + libName + ' && PACKAGE_NAME=@kreuzerk/monoleasa-baz VERSION=${nextRelease.version} npm run update-deps',
    }],
    [
