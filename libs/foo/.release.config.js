...
module.exports = {
  ...
  plugins: [
    ...
    ["@semantic-release/exec", {
      prepareCmd: 'VERSION=${nextRelease.version} npm run bump-version:' + libName + ' && VERSION=${nextRelease.version} PACKAGE_NAME=@kreuzerk/monoleasa-foo npm run update-deps',
    }],
    [
